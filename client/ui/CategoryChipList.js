...
const CategoryChipList = (props) => {
  ...
  const {
    categories,
    categoryIds, selected, ignoreHint,
    onSelect, className, classes
  } = props;
  ...
  return (
    <Grid className={classes.container}>
      ...
      </div>  
      {
        ...
        <Typography className={classes.categoryHint}>Some popular writers in {selectedCategory.label}</Typography>
        : null
      }
    </Grid>
  );
